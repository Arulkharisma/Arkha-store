...
<body>
    ...
    <!-- produk -->
    <section id="celana" class="pt-lg-5 mb-5 mt-3">
        <div class="container">
            <div class="row mt-lg-5">
                <div class="col">
                    <h4 class="mt-2" style="border-bottom: 2px solid hotpink; width: max-content; color: royalblue;">Celana</h4>
                </div>
            </div>
            ...
            <div class="row mt-4 ">
                ...
                $query = "SELECT * FROM data_produk WHERE id_kategori = 2";
