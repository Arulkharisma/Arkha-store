...
<body>
    ...
    <!-- produk -->
    <section id="hoodie" class="pt-lg-5 mb-5 mt-3">
        <div class="container">
            ...
            <div class="row mt-4 ">
                ...
                $query = "SELECT * FROM data_produk WHERE id_kategori = 3";
    ...
    <footer id="kontak" class="pb-3 bg-light" style="font-family: 'Jost', Arial, sans-serif; font-size: 15px; line-height: 25px;">
        <div class="container pt-3" style="border-bottom: 1px solid grey;">
            <div class="row offset-md-1">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-3 mb-5 mt-3">
                    ...
                    <li class="list-group-item"><i class="bi bi-envelope me-2 icon"></i> arulkharisma01@gmail.com</a>
                    </li>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-3 mb-5 mt-3">
                    ...
                    <li class="list-group-item mb-1"><img src="img/anteraja.png" alt="anteraja"> <img src="img/indopaket.png" alt="indopaker"> <img src="img/ninjaexpres.png" alt="ninjaexpres">
                    </li>
