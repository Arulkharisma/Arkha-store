          ...
          <div class="container">
              <div class="row pt-5">
                  <div class="col-lg-6 mt-4 justify-content-center text-poppins">
                      ...
                      <a href="#produkTerbaru" class="av-link p-2 navbtn" data-aos="fade-rigt" data-aos-duration="500" data-aos-delay="1200" style="border: 2px solid royalblue; border-radius: 10px; font-weight: 400;">Pesan Sekarang <i class=" bi bi-arrow-right" style="color: black;"></i></button></a>
                  </div>
