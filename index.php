...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light fixed-top">
        <div class="container">
            <a class="navbar-brand fw-bold fs-4 text-poppins" href="#home"><img src="img/logo.png" alt="Logo" width="35px" height="30px" class="d-inline-block align-text-top me-1"><span style="color:royalblue">Arkha</span><span style="color: hotpink;">&co</span></a>
        ...
        <div class="container">
            <div class="row pt-5">
                <div class="col-lg-6 mt-4 justify-content-center text-poppins">
                    ...
                    <h1 class="fw-bold" data-aos="fade-right" data-aos-duration="1000"><span style="color: hotpink;">Temukan</span> <span style="color: royalblue;">Outfit</span><br><span style="color: royalblue;">Impian </span><span style="color: hotpink;">Anda<br>Disini</span></h1>
                    ...
                    <a href="#produkTerbaru" class="av-link p-2 navbtn text-white" data-aos="fade-rigt" data-aos-duration="500" data-aos-delay="1200" style="border: 2px solid white; border-radius: 10px; font-weight: 400;">Pesan Sekarang <i class=" bi bi-arrow-right" style="color: white;"></i></button></a>
                </div>
